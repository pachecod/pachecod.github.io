...
// This script controls the immersive story functionality
...
AFRAME.registerSystem('loading-manager', {
    init: function () {
      ...
      this.loadingText.textContent = 'Loading Immersive Story...';
  ...
  AFRAME.registerComponent("spot", {
    ...
    init: function () {
      ...
      if (data.audio) {
        ...
        // JS block for slideshow controls
...
document.querySelector('#nav-left').addEventListener('click', () => {
  ...
  imagePanel.setAttribute('material', 'src', slides[currentSlide]);
});
...
document.querySelector('#nav-right').addEventListener('click', () => {
  ...
  // Day-night cycle component - DISABLED
  /*
  AFRAME.registerComponent('day-night-cycle', {
    ...
    init: function() {
      ...
      this.skyDay = 'images/day.jpg';
      this.skyNight = 'images/night.jpg';
      this.cycleTime = 0;
